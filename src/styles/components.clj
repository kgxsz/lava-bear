...
(def text
  [:.c-text {:font-family "'Raleway', Arial"
   ...
   [:&--link {:color (:grapefruit constants/color)
              :text-shadow [[(em 0.04) 0 (:white constants/color)]
                            [(em -0.04) 0 (:white constants/color)]
                            [(em 0.08) 0 (:white constants/color)]
                            [(em -0.08) 0 (:white constants/color)]
                            [0 (em -0.04) (:white constants/color)]
                            [(em 0.04) (em -0.04) (:white constants/color)]
                            [(em -0.04) (em -0.04) (:white constants/color)]
                            [(em 0.08) (em -0.04) (:white constants/color)]
                            [(em -0.08) (em -0.04) (:white constants/color)]
                            [0 (em -0.08) (:white constants/color)]
                            [(em 0.04) (em -0.08) (:white constants/color)]
                            [(em -0.04) (em -0.08) (:white constants/color)]
                            [(em 0.08) (em -0.08) (:white constants/color)]
                            [(em -0.08) (em -0.08) (:white constants/color)]
                            [0 (em 0.04) (:white constants/color)]
                            [(em 0.04) (em 0.04) (:white constants/color)]
                            [(em -0.04) (em 0.04) (:white constants/color)]
